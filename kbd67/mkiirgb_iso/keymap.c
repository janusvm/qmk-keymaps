...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_65_iso_blocker(
        ...
        KC_LCTL,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,   KC_J,    KC_K,    KC_L,    DK_AE,  DK_OSTR, DK_QUOT, KC_ENT,  KC_PGDN,
        KC_LSFT,  DK_LABK, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   KC_N,    KC_M,    KC_COMM, KC_DOT, DK_MINS, KC_RSFT, KC_UP,   KC_END,
        CAPSWRD,  KC_LGUI, KC_LALT, /******/ /******/ /******/ KC_SPC, /******/ /******/ KC_RALT, FN,     /******/ KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [_COLEMAK] = LAYOUT_65_iso_blocker(
        ...
        KC_LSFT,  DK_LABK, KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    KC_K,    KC_H,    KC_COMM, KC_DOT, DK_MINS, KC_RSFT, KC_UP,   KC_END,
        CAPSWRD,  KC_LGUI, KC_LALT, /******/ /******/ /******/ KC_SPC,  /******/ /******/ KC_RALT, FN,     /******/ KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [_FN] = LAYOUT_65_iso_blocker(
        ...
        KC_CAPS, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, RGB_SPI, _______, _______, _______, _______, KC_PSCR, KC_SLCK, KC_PAUS, /******/ _______,
