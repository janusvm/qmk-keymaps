...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_65_iso_blocker(
        ...
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    DK_ARNG, DK_DIAE, /******/ KC_PGUP,
        CAPSCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    DK_AE,   DK_OSTR, DK_QUOT, KC_ENT,  KC_PGDN,
    ...
    [_COLEMAK] = LAYOUT_65_iso_blocker(
        ...
        CAPSCTL, KC_A,    KC_R,    KC_S,    KC_T,    KC_G,    KC_M,    KC_N,    KC_E,    KC_I,    KC_O,    DK_OSTR, DK_QUOT, KC_ENT,  KC_PGDN,
